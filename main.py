...
def register():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            ...
            flash("This email is already registered, would you rather login?")
...
def show_post(post_id):
    ...
    if comment_form.validate_on_submit():
        if not current_user.is_authenticated:
            ...
            db.session.commit()
    return render_template("post.html", post=requested_post, form = comment_form, logged_in = current_user.is_authenticated, current_user = current_user)
